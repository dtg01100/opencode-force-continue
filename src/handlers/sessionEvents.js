...
const WAITING_INDICATORS = /\b(do you|can i|should i|could you|would you|what (do|can|should|would|could)|how (can|do|would|could)|are you|does this|would this|option [a-z]?|[a-z]\)|\(?[a-z][\).])\b/i;
